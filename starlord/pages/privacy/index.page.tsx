            ...
            >
              ...
              <div className="page-body">
                ...
                <p id="3d49d9b5-3d1a-40e2-af7b-3be704b536bc" className="">
                  ...
                  process the information we collect about or from you through
                  our Website located at&nbsp;
                  <a href="https://todocity.app/static/home">
                    https://todocity.app/
                  </a>
                  &nbsp;and/or our Apps (our “Digital Platforms”), from our
                  users, subscribers, visitors and other users of our technology
                  and platforms (“Service”), and when you otherwise interact
                  with us. This Privacy Policy may be updated by us from time to
                  time without notice to you. By accepting this Privacy Policy,
                ...
                <p id="6d1e25cb-026e-4d12-a55e-cbfc763a2924" className="">
                  ...
                  have the meaning set forth in our Terms of Service.
                </p>
                ...
                <p id="eb0d0bce-5894-4d29-b009-cecdab91b67b" className="">
                  ...
                  receives the following types of information from visitors to
                  the Website; users, subscribers or other users of its
                  Platforms; and from third-party integration partners, which
                ...
                <p id="dcb704fc-c5dc-40fd-9fd1-435775dd206f" className="">
                  ...
                  any other information you provide in messages to us. We use
                  such contact information for purposes such as providing you
                  with information about the Service, responding to your
                  inquiries, sending you email alerts (including marketing
                  emails), verifying your identity or providing you the Service.
                </p>
                ...
                <p id="899b515b-ceb6-4558-9160-ed541a686e3c" className="">
                  In connection with the creation of an account on our
                  Platforms, we collect account credentials such as your email,
                  username, and password. We use this account information to
                  create your account, including to verify your identity. We
                  also use this information to manage your account, including
                  your transactions. If you choose to log into your account
                  through Google, Apple or Facebook, we capture and store the
                  User ID and email address connected to the respective account,
                  so we can verify your identity when you log in.
                </p>
                ...
                <p id="2f50f18c-614f-4c8c-bec4-75152cb8c5d0" className="">
                  ...
                  photos, images, task lists, graphics, artwork, links to
                  outside content, and or other material. It is your decision
                  what kind of personal information (if any) you submit. We do
                  not use personal information posted in your content in any way
                  except as needed to enforce the community guidelines and terms
                  of service or to provide assistance and troubleshooting issues
                  with service to the account.
                </p>
                ...
                <p id="f2c3144b-5ab4-4b7d-af43-ef273935d1a1" className="">
                  ...
                  invoices and/or transaction confirmations). Additionally, we
                  use this Transaction Information to: communicate with you;
                  screen our transactions for potential risk or fraud; and when
                  in line with the preferences you have shared with us, provide
                  you with information or advertising relating to our products
                  or Service. Our third-party payment processing providers may
                  also collect from you, process and store your payment
                  information including credit card information and/or bank
                  account information in accordance with their respective
                  privacy policies linked to below:
                </p>
                <ul
                ...
                <p id="ce6f74ec-ff34-4921-a178-37ca170afe93" className="">
                  We reserve the right to change our payment vendors at any
                  time, or to use additional payment vendors, at our discretion,
                  and will update this Privacy Policy from time to time
                  accordingly.
                </p>
                ...
                <p id="87bccd31-2127-4a01-9b69-f2969c252c17" className="">
                  ...
                  accesses those servers. The log files may contain data about
                  the nature of such access, including the device’s IP address,
                  user agent string (e.g., operating system and browser
                  type/version), and the pages you have clicked on while on our
                  Service, and details regarding your activity on the Service
                  such as time spent on the Service and other performance and
                  usage data. We may use these log files for purposes such as
                  assisting in monitoring and troubleshooting errors and
                  incidents, analyzing traffic, or optimizing the user
                  experience.
                </p>
                ...
                <p id="798636ea-106c-4e13-9cba-bf7550e56736" className="">
                  ...
                  pixel and other similar technologies to record information
                  about how you use the Website, and to facilitate log-in and
                  payments. Cookies are small packets of data that a website
                  stores on your computer’s or mobile device’s hard drive (or
                  other storage medium) so that your computer will “remember”
                  information about your use. We use both first and third party
                  session cookies and persistent cookies. Below is a general
                  primer on session and persistent cookies; information
                  collected by cookies depends on its particular purpose. For
                  more information, please see the information regarding
                ...
                >
                  <li style={{ listStyleType: 'disc' }}>
                    ...
                    remains on your device for an extended period of time or
                    until you delete it. Persistent cookies enable us to better
                ...
                <p id="1b0dd020-853a-4f1c-8467-a54899696d87" className="">
                  ...
                  may be able to turn that feature off on your device. You may
                  refuse to accept cookies from the Service at any time by
                  activating the setting on your browser which allows you to
                  refuse cookies. Further information about the procedure to
                  follow in order to disable cookies can be found on your
                  Internet browser provider’s website via your help screen. You
                  ...
                  information about targeting and advertising cookies and how
                  you can opt out, you can also visit&nbsp;
                  <a href="https://optout.aboutads.info/">
                    https://optout.aboutads.info
                  </a>
                  . Please be aware that if cookies are disabled, not all
                  features of the Service may operate properly or as intended.
                </p>
                ...
                <p id="10f89acb-4936-4327-8b8d-df757b76becb" className="">
                  ...
                  reports on activity (based on their collection of IP
                  addresses, Internet service provider, browser type, operating
                  system and language, referring and exit pages and URLs, data
                  and time, amount of time spent on particular pages, what
                  sections of the Service you visit, number of links clicked,
                  search terms and other similar usage data) and analyzing
                  performance metrics. These third parties use cookies and other
                  technologies to help collect, analyze, and provide us reports
                  or other data.
                </p>
                <p id="c1fc27b4-6eaf-4157-bda5-02929eb44bf7" className="">
                  ...
                  Policy. For more information on these third parties, including
                  how to opt out from certain data collection, please visit the
                  sites below. Please be advised that if you opt out of any
                  service, you may not be able to use the full functionality of
                  the Service.
                </p>
                ...
                <p id="95f37e24-7ad3-46aa-8778-fcad6fec5996" className="">
                  ...
                  personalizing or otherwise understanding how you engage with
                  ads or other content. These third parties may use cookies,
                  pixel tags, or other technologies to collect information in
                  furtherance of such purposes, including to tailor, target
                  (i.e., behavioral, contextual, retargeting, and remarketing),
                  analyze, report on, and/or manage advertising campaigns or
                  other initiatives. For example, when a browser visits a site,
                  pixel tags enable us and these third-parties to recognize
                  certain cookies stored within the browser to learn which ads
                  or other content bring a user to a given site. Information
                  that we may receive from these third-parties, including
                  through their service providers, may include advertising
                  identifiers, IP addresses, reports, and campaign data.
                </p>
                ...
                <p id="1035772c-fb00-48ed-bdd3-adba7c93bfd8" className="">
                  ...
                  Service. This consent may be provided by you on the device
                  level (e.g., you have consented to location Service generally
                  through your browser’s settings) or by accepting our request
                  for geolocation access on the Service. Please consult your
                  browser’s documentation regarding how to turn off location
                  Service. If you disable location Service, you may not be able
                  to use the full array of features and functionalities
                ...
                <p id="683ad8f0-2593-49b6-bebf-113d6df2bf81" className="">
                  ...
                  de-identified form to operate, maintain, manage, and improve
                  the Service. We may share this aggregate or de-identified data
                  with our affiliates, agents, and business partners. We may
                  also disclose aggregated or de-identified user statistics to
                  describe the Service to current and prospective business
                ...
                >
                  <li style={{ listStyleType: 'disc' }}>
                    ...
                    information to certain types of third party companies but
                    only to the extent needed to enable them to provide such
                    service. The types of companies that may receive personal
                    information and their functions are: hosting service,
                    technical assistance, database management/back-up service,
                    use analytics, marketing, and customer service.
                  </li>
                </ul>
                <ul
                ...
                >
                  <li style={{ listStyleType: 'disc' }}>
                    ...
                    marketing and sale of our products and Service.
                  </li>
                </ul>
                ...
                <p id="428db830-feae-44a1-a8a9-67db64350a96" className="">
                  ...
                  all of our assets, we expect that the information that we have
                  collected, including personal information, would be
                  transferred to the surviving entity in a merger or the
                  acquiring entity. All such transfers shall be subject to our
                  commitments with respect to the privacy and confidentiality of
                  such personal information as set forth in this Privacy Policy.
                  This Notice shall be binding upon TodoCity and its legal
                ...
                <p id="8b1e756f-a0c9-4de1-99f1-2ce2b1ca2771" className="">
                  ...
                  by clicking the avatar box in the upper left hand corner of
                  the browser window, or by going to “Settings” and then
                  selecting the “Profile” option in the menu.
                </p>
                ...
                <p id="555d0455-eb15-460f-a538-dccc8624bb6a" className="">
                  ...
                  associated with it, please email us at admin@todocity.app and
                  we will handle your request within 30 days.
                </p>
                <p id="2c6c0b8a-d927-4c26-bc89-666e240ac419" className="">
                  ...
                  cannot opt out of receiving transactional e-mails related to
                  the Service.
                </p>
                ...
                <p id="a593a7ff-d7f9-45da-ad6a-3d7d9d203881" className="">
                  ...
                  designed to protect your personal information from loss,
                  misuse and unauthorized access, disclosure, alteration and
                  destruction, taking into account the risks involved in
                  processing and the nature of such data, and to comply with
                  applicable laws and regulations. Please understand, however,
                  that no security system is impenetrable. We cannot guarantee
                  the security of our databases or the databases of the third
                  parties with which we may share your information (as permitted
                  herein), nor can we guarantee that the information you supply
                  will not be intercepted while being transmitted over the
                  Internet. In particular, e-mail sent to us may not be secure,
                  and you should therefore take special care in deciding what
                ...
                <p id="c746ff11-3f32-49a7-802b-4f1b7454ecd7" className="">
                  ...
                  information to us, please contact us at admin@todocity.app,
                ...
                <p id="ff3716ee-38e3-40a4-a51c-80e38bae6ba4" className="">
                  ...
                  used on computers, servers, and systems located outside of
                  your state, province, country, or other governmental
                  jurisdiction where the privacy laws may not be as protective
                  as those in your country of origin. If you are located outside
                  the United States and choose to use the Service, you do so at
                  your own risk.
                </p>
                ...
                <p id="14e4e753-372d-4ff7-8d51-1ba3e049530c" className="">
                  ...
                  products marketed by those third parties. If you wish to
                  submit a request pursuant to Section 1798.83, please contact
                  TodoCity via email at&nbsp;
                  <a href="mailto:admin@todocity.app">admin@todocity.app</a>.
                </p>
                ...
                <p id="932f9166-8d09-4f30-8774-3ccf89acf581" className="">
                  ...
                  (“External Sites”). TodoCity has no control over the privacy
                  practices or the content of any such External Sites. As such,
                  we are not responsible for the content or the privacy policies
                  of such External Sites. You should check the applicable
                  privacy policy or privacy policy and terms of use when
                  visiting any such External Sites.
                </p>
                ...
                <p id="a3183fea-30de-46af-bdc1-fe364edbd14e" className="">
                  ...
                  you. By accessing the Service after we make any such changes
                  to this Privacy Policy, you are deemed to have accepted such
                  changes. Please be aware that, to the extent permitted by
                  applicable law, our use of the information collected is
                  governed by the Privacy Policy in effect at the time we
                  collect the information. Please refer back to this Privacy
